...
最新版本为 0.24：住宅窗户具有关闭、打开、破碎三种状态，玩家可打开并翻越，碎窗翻越存在手脚擦伤风险；两层木板分别记录耐久，可维修、拆除或被僵尸逐层破坏。门具有独立耐久，僵尸会选择玩家所在建筑的门窗入口，破坏后进入室内。门窗、玻璃和每层木板的耐久均进入存档。说明见 `docs/door-window-breach-system-v1.md`。
