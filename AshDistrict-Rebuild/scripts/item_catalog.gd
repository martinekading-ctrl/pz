...
const ITEMS := {
	...
	"crowbar":{"name":"撬棍","category":"weapon","weight":2.1,"stack":1,"icon":"⌁","desc":"结实可靠的钝器，攻击与击退较均衡。","damage":34,"range":1.35,"swing":0.90,"knockback":0.42,"durability":100.0,"wear":1.0,"visual_length":30.0,"visual_color":"9a7060"},
	"baseball_bat":{"name":"棒球棍","category":"weapon","weight":1.3,"stack":1,"icon":"▰","desc":"攻击距离较长，擅长击退。","damage":30,"range":1.55,"swing":1.0,"knockback":0.56,"durability":80.0,"wear":2.0,"visual_length":34.0,"visual_color":"8b603f"},
	"kitchen_knife":{"name":"厨房刀","category":"weapon","weight":0.45,"stack":1,"icon":"†","desc":"挥动迅速，但攻击距离与耐久较低。","damage":24,"range":0.95,"swing":0.58,"knockback":0.16,"durability":55.0,"wear":1.0,"visual_length":21.0,"visual_color":"b9bec0"},
	"hand_axe":{"name":"手斧","category":"weapon","weight":1.4,"stack":1,"icon":"◆","desc":"伤害高，但攻击前后动作较慢。","damage":42,"range":1.20,"swing":1.1,"knockback":0.38,"durability":70.0,"wear":1.5,"visual_length":27.0,"visual_color":"6f5844"},
