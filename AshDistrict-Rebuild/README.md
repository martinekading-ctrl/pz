...
最新版本为 0.28：加入按世界时间中断的供电与供水。厨房和浴室水龙头可直接饮水，并把饮水后留下的空塑料瓶重新灌装；停水后这些操作立即失效。冰箱显示制冷状态，停电会把鲜食保质期缩短到约 12 小时，夜间无电室内会明显变暗。断供时间、空瓶循环和世界状态完整进入存档。说明见 `docs/utility-outage-system-v1.md`。
