...
0.33.1 接入实时 3D 玩家、僵尸与旅行车。当前为原创低多边形模型初稿，透明 3D 视口按脚底坐标合成到等距地图，沿用现有碰撞、搜索、驾驶和存档。角色具有肢体程序动画，车辆具有真实转向和车轮旋转。外观精修、骨骼动画与 Android 真机性能仍待完成，不能视为最终角色美术交付。见 `docs/live-3d-v1.md`。
