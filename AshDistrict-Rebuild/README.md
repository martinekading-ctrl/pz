...
最新版本为 0.25：清空住宅中的僵尸后，可在床边将住宅设为安全屋；睡眠会以可见进度推进八小时，恢复疲劳和体力并继续消耗食水，危险靠近或门窗遭撞击时会惊醒。认领安全屋、完整睡眠、重新进入安全屋以及正常退出都会写入独立自动存档；继续游戏会选择手动存档与自动存档中较新的进度。旧版存档自动迁移。说明见 `docs/safehouse-sleep-system-v1.md`。
...
第一块可上线区域的系统差距、完成比例和 0.18–0.24 顺序见 `docs/vertical-slice-roadmap-v1.md`。
