...
最新版本为 0.26：加入面包、罐头汤、能量棒、汽水、咖啡、消毒剂、抗生素和强力胶带。物资按冰箱、厨房、商店货架、浴室、仓储、收银台和尸体分别投放；面包会随游戏时间变质，药物接入分部位治疗，胶带可修补当前武器。旧存档中的已搜索容器保持原样，未搜索容器自动补入新版战利品。说明见 `docs/item-loot-expansion-v1.md`。
